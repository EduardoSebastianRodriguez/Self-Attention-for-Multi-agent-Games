"""Sec. IV-C baseline: GAT (GATv2) policy on Simple-Tag, trained with MADDPG.

Evaluate a trained checkpoint (default) or train from scratch:

    python gnn_exp_maddpg.py --checkpoint path/to/checkpoint_3000000.pt
    python gnn_exp_maddpg.py --train --output outputs/gnn_simple_tag_maddpg
"""
import argparse
...
from benchmarl.algorithms.maddpg import MaddpgConfig
from benchmarl.experiment import Experiment, ExperimentConfig
from benchmarl.models import GnnConfig, MlpConfig

DEFAULT_OUTPUT = Path(__file__).resolve().parent / "outputs" / "gnn_simple_tag_maddpg"
